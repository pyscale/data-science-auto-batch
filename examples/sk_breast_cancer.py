...
config = MLPipelineStateModel.parse_file("config/examples/ml/elastic-binary-tree-classification.json")

mlflow.set_experiment(experiment_name="Elastic Binary Tree Clf")
...
with mlflow.start_run(run_name="Elastic Binary Tree Clf") as run:
